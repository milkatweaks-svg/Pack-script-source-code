...
t1.MainTab:Button({
	...
	Callback = function(_)
		...
		if LocalPlayer3.Character and LocalPlayer3.Character:FindFirstChild("Humanoid") then
...
local DeclineTrade, u51, u52, Players3, RunService2, LocalPlayer4, n2, n3, n4, E, u61, u62, u63, u64, u65, u66, u67, u68, u69, E2, u71, u72, Players4, VirtualUser2, RunService3, LocalPlayer5, t9, u78, u79, u80, t11, u82, CurrentCamera2, LocalPlayer6, u85, u86, n5, n6, n7, n8, LocalPlayer7, u92, t14, t15, CurrentCamera3, LocalPlayer8, u97, u98, u99, u100, t16, t17, t18, t19, t20, u107, u108, LocalPlayer9, u112, u113, RunService4, Workspace3, LocalPlayer10, u119, u120, u121, u122, n11, u124, vector3
			...
			if player ~= LocalPlayer4 then
				if player.Character then
					...
					if Humanoid and Humanoid.Health > 0 then
						...
						if HumanoidRootPart2 and u66(player) then
		...
		if Character then
			...
			if Humanoid and Humanoid.Health > 0 then
				...
				if HumanoidRootPart then
					pcall(function()
						VirtualUser2:ClickButton1(Vector2.new())
	...
	RunService3.RenderStepped:Connect(function(dt)
		if u86 then
			...
			if v358 and v358.Character then
				...
				local LocalCharacter = LocalPlayer7.Character or LocalPlayer7.CharacterAdded:Wait()
				local HumanoidRootPart5 = LocalCharacter:WaitForChild("HumanoidRootPart")
				if HumanoidRootPart then
					if not (n8 > 0) then
...
local RunService5, Workspace4, VirtualUser3, LocalPlayer12, CoinCollected, t24, t25, u162, u163, Part, u166, u167, u168, u169, TextLabel
...
do
	...
	VirtualUser3 = game:GetService("VirtualUser")
	...
	LocalPlayer13.Idled:connect(function()
		VirtualUser3:ClickButton2(Vector2.new())
	end)
